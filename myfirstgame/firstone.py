...
bgimg = pygame.image.load('E:\\PSV_vs\\myfirstgame\\gamebg.jpeg')
bgimg = pygame.transform.scale(bgimg, (screen_length,screen_height)).convert_alpha()
startimg = pygame.image.load('E:\\PSV_vs\\myfirstgame\\start.jpeg')
startimg = pygame.transform.scale(startimg, (screen_length,screen_height)).convert_alpha()
overimg = pygame.image.load('E:\\PSV_vs\\myfirstgame\\overbg.jpeg')
        ...
        for event in pygame.event.get():
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE:
                    mixer.music.load('E:\\PSV_vs\\myfirstgame\\gmusic.mp3',)
...
def mygame():
    ...
    vel_x = 0
    vel_y = 0
    with open("E:\\PSV_vs\\myfirstgame\\highscore.txt", "r") as f:
        hscore = f.read()
    ...
    while not game_exit:
        if game_over:
            ...
            with open("E:\\PSV_vs\\myfirstgame\\highscore.txt", "w") as f:
                f.write(str(hscore))
            ...
            if snake_x>screen_length or snake_x<0 or snake_y>screen_height or snake_y<0:
                game_over = True
                pygame.mixer.music.load('E:\\PSV_vs\\myfirstgame\\govermusic.wav')
