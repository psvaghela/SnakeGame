...
search_url = "https://www.linkedin.com/search/results/content/?keywords=hiring%20c%2B%2B%20developer&origin=GLOBAL_SEARCH_HEADER&sid=Y%3B2"
...
df.to_csv("C++.csv",header=True,index=False)