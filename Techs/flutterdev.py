...
search_url = "https://www.linkedin.com/search/results/content/?keywords=hiring%20flutter%20developer&origin=GLOBAL_SEARCH_HEADER&sid=Ppv"
...
df.to_csv("flutter.csv",header=True,index=False)