...
search_url = "https://www.linkedin.com/search/results/content/?keywords=hiring%20python%20developer&origin=GLOBAL_SEARCH_HEADER&sid=Y(!"
...
df.to_csv("python.csv",header=True,index=False)