...
search_url = "https://www.linkedin.com/search/results/content/?keywords=Hiring%20nodejs%20developer&origin=SWITCH_SEARCH_VERTICAL&sid=FTy"
...
df.to_csv("nodejs.csv",header=True,index=False)
