...
search_url = "https://www.linkedin.com/search/results/content/?keywords=hiring%20php%20developer&origin=GLOBAL_SEARCH_HEADER&sid=F%3B6"
...
df.to_csv("php.csv",header=True,index=False)