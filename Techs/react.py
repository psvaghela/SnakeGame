...
search_url = "https://www.linkedin.com/search/results/content/?keywords=Hiring%20react%20developer&origin=GLOBAL_SEARCH_HEADER&sid=!vA"
...
df.to_csv("react.csv",header=True,index=False)
