...
search_url = "https://www.linkedin.com/search/results/content/?keywords=hiring%20perl%20developer&origin=GLOBAL_SEARCH_HEADER&sid=GFE"
...
df.to_csv("perl.csv",header=True,index=False)