...
search_url = "https://www.linkedin.com/search/results/content/?keywords=hiring%20laravel%20developer&origin=GLOBAL_SEARCH_HEADER&sid=gL0"
...
df.to_csv("laravel.csv",header=True,index=False)