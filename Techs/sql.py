...
search_url = "https://www.linkedin.com/search/results/content/?keywords=hiring%20sql%20developer&origin=SWITCH_SEARCH_VERTICAL&sid=fH)"
...
df.to_csv("sql.csv",header=True,index=False)