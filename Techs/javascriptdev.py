...
search_url = "https://www.linkedin.com/search/results/content/?keywords=hiring%20javascript%20developer&origin=GLOBAL_SEARCH_HEADER&sid=H6%3B"
...
df.to_csv("javascript.csv",header=True,index=False)