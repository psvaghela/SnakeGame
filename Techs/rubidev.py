...
search_url = "https://www.linkedin.com/search/results/content/?keywords=hiring%20ruby%20developer&origin=GLOBAL_SEARCH_HEADER&sid=6v7"
...
df.to_csv("ruby.csv",header=True,index=False)